...
import { Sparkles, DollarSign, Leaf, TrendingDown, Check, Lightbulb } from 'lucide-react';
...
export function MealPlanGenerator() {
  ...
  const handleGenerate = () => {
    ...
    // todo: remove mock functionality - simulate AI processing with natural language prompt
    setTimeout(() => {
      ...
      <div className="space-y-4">
        ...
        <Card className="max-w-3xl mx-auto p-6">
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-muted-foreground mt-1">
                  Use natural language to tell us what you're looking for. For example: "I need a week of high-protein vegetarian meals under $40" or "Give me quick dinners using ingredients from my pantry"
                </p>
              </div>
            </div>
            ...
            <Textarea
              id="prompt"
              placeholder="Example: I want healthy breakfast and lunch ideas for the week that are quick to prepare, use seasonal vegetables, and fit my gluten-free diet. Budget is around $50 for the week."
              value={prompt}
